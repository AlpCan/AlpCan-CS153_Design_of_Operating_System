...
_lab2proc1:     file format elf32-i386
...
int main(int argc, char *argv[]){
   ...
   6:	83 ec 10             	sub    $0x10,%esp
    set_prior(31);
   9:	c7 04 24 1f 00 00 00 	movl   $0x1f,(%esp)
  10:	e8 fd 02 00 00       	call   312 <set_prior>
  15:	ba 10 27 00 00       	mov    $0x2710,%edx
...
0000030a <waitpid>:
SYSCALL(waitpid) // waitpid implementation
 30a:	b8 17 00 00 00       	mov    $0x17,%eax
 30f:	cd 40                	int    $0x40
 311:	c3                   	ret    

00000312 <set_prior>:
SYSCALL(set_prior) //system call implementation for set_prior
