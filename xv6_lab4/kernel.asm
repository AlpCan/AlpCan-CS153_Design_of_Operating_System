...
80106d2c:	eb 15                	jmp    80106d43 <shm_open+0x53>
...
80106d32:	74 1f                	je     80106d53 <shm_open+0x63>
    for(i = 0 ; i < 64 ; i++){ //there are 64 pages
80106d34:	83 c2 01             	add    $0x1,%edx
80106d37:	83 c1 0c             	add    $0xc,%ecx
80106d3a:	83 fa 40             	cmp    $0x40,%edx
80106d3d:	0f 84 7d 00 00 00    	je     80106dc0 <shm_open+0xd0>
        if(j == 64 && shm_table.shm_pages[i].id == 0) {//segment id does not exist
80106d43:	83 f8 40             	cmp    $0x40,%eax
80106d46:	8b 19                	mov    (%ecx),%ebx
80106d48:	75 e6                	jne    80106d30 <shm_open+0x40>
80106d4a:	85 db                	test   %ebx,%ebx
80106d4c:	0f 44 c2             	cmove  %edx,%eax
        if(shm_table.shm_pages[i].id == id){//segment id exist
80106d4f:	39 de                	cmp    %ebx,%esi
80106d51:	75 e1                	jne    80106d34 <shm_open+0x44>
            id_existence = 1;
...
80106d53:	8d 1c 52             	lea    (%edx,%edx,2),%ebx
80106d56:	c1 e3 02             	shl    $0x2,%ebx
80106d59:	8b 83 f8 54 11 80    	mov    -0x7feeab08(%ebx),%eax
...
80106d7f:	8b 47 04             	mov    0x4(%edi),%eax
80106d82:	89 04 24             	mov    %eax,(%esp)
80106d85:	e8 c6 f7 ff ff       	call   80106550 <mappages>
            //increase the refence count
            shm_table.shm_pages[i].refcnt++;
80106d8a:	83 83 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%ebx)
            id_existence = 1;
80106d91:	bb 01 00 00 00       	mov    $0x1,%ebx
...
80106dc0:	83 f8 40             	cmp    $0x40,%eax
80106dc3:	74 6e                	je     80106e33 <shm_open+0x143>
        shm_table.shm_pages[j].id = id;
80106dc5:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
80106dc8:	c1 e3 02             	shl    $0x2,%ebx
80106dcb:	89 b3 f4 54 11 80    	mov    %esi,-0x7feeab0c(%ebx)
        shm_table.shm_pages[j].frame = kalloc();
80106dd1:	e8 da b6 ff ff       	call   801024b0 <kalloc>
        memset(shm_table.shm_pages[j].frame, 0, PGSIZE);
...
80106de6:	89 04 24             	mov    %eax,(%esp)
        shm_table.shm_pages[j].frame = kalloc();
80106de9:	89 83 f8 54 11 80    	mov    %eax,-0x7feeab08(%ebx)
        memset(shm_table.shm_pages[j].frame, 0, PGSIZE);
80106def:	e8 9c d4 ff ff       	call   80104290 <memset>
        mappages(current_process->pgdir, (char *)sz, PGSIZE, V2P(shm_table.shm_pages[j].frame), PTE_W|PTE_U);
80106df4:	8b 83 f8 54 11 80    	mov    -0x7feeab08(%ebx),%eax
80106dfa:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e01:	00 
80106e02:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e09:	00 
80106e0a:	05 00 00 00 80       	add    $0x80000000,%eax
80106e0f:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106e13:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106e16:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e1a:	8b 47 04             	mov    0x4(%edi),%eax
80106e1d:	89 04 24             	mov    %eax,(%esp)
80106e20:	e8 2b f7 ff ff       	call   80106550 <mappages>
        shm_table.shm_pages[j].refcnt++;
80106e25:	83 83 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%ebx)
    int id_existence = 0;
80106e2c:	31 db                	xor    %ebx,%ebx
80106e2e:	e9 63 ff ff ff       	jmp    80106d96 <shm_open+0xa6>
80106e33:	31 db                	xor    %ebx,%ebx
80106e35:	e9 5c ff ff ff       	jmp    80106d96 <shm_open+0xa6>
...
80106e56:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
    ...
    for(i = 0 ; i < 64 ; i++) { //there are 64 pages
80106e5b:	31 d2                	xor    %edx,%edx
80106e5d:	eb 0c                	jmp    80106e6b <shm_close+0x2b>
80106e5f:	90                   	nop
80106e60:	83 c2 01             	add    $0x1,%edx
80106e63:	83 c0 0c             	add    $0xc,%eax
80106e66:	83 fa 40             	cmp    $0x40,%edx
80106e69:	74 25                	je     80106e90 <shm_close+0x50>
        if (shm_table.shm_pages[i].id == id) {//segment id exist
80106e6b:	39 18                	cmp    %ebx,(%eax)
80106e6d:	75 f1                	jne    80106e60 <shm_close+0x20>
            if(shm_table.shm_pages[i].refcnt == 1){
80106e6f:	8b 48 08             	mov    0x8(%eax),%ecx
80106e72:	83 f9 01             	cmp    $0x1,%ecx
80106e75:	74 39                	je     80106eb0 <shm_close+0x70>
                shm_table.shm_pages[i].id = 0;
                shm_table.shm_pages[i].frame = 0;
                shm_table.shm_pages[i].refcnt = 0;
                break;
            ...
            if(shm_table.shm_pages[i].refcnt > 1){
80106e77:	7e e7                	jle    80106e60 <shm_close+0x20>
                shm_table.shm_pages[i].refcnt--;
80106e79:	83 e9 01             	sub    $0x1,%ecx
    for(i = 0 ; i < 64 ; i++) { //there are 64 pages
80106e7c:	83 c2 01             	add    $0x1,%edx
                shm_table.shm_pages[i].refcnt--;
80106e7f:	89 48 08             	mov    %ecx,0x8(%eax)
80106e82:	83 c0 0c             	add    $0xc,%eax
    for(i = 0 ; i < 64 ; i++) { //there are 64 pages
80106e85:	83 fa 40             	cmp    $0x40,%edx
80106e88:	75 e1                	jne    80106e6b <shm_close+0x2b>
80106e8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            }
        }
    }
    resultRefcnt = shm_table.shm_pages[id].refcnt;
80106e90:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
80106e93:	8b 1c 85 fc 54 11 80 	mov    -0x7feeab04(,%eax,4),%ebx
    release(&(shm_table.lock));
80106e9a:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ea1:	e8 9a d3 ff ff       	call   80104240 <release>


    return resultRefcnt; //added to remove compiler warning -- you should decide what to return
}
80106ea6:	83 c4 14             	add    $0x14,%esp
80106ea9:	89 d8                	mov    %ebx,%eax
80106eab:	5b                   	pop    %ebx
80106eac:	5d                   	pop    %ebp
80106ead:	c3                   	ret    
80106eae:	66 90                	xchg   %ax,%ax
                shm_table.shm_pages[i].id = 0;
80106eb0:	8d 04 52             	lea    (%edx,%edx,2),%eax
80106eb3:	c1 e0 02             	shl    $0x2,%eax
80106eb6:	c7 80 f4 54 11 80 00 	movl   $0x0,-0x7feeab0c(%eax)
80106ebd:	00 00 00 
                shm_table.shm_pages[i].frame = 0;
80106ec0:	c7 80 f8 54 11 80 00 	movl   $0x0,-0x7feeab08(%eax)
80106ec7:	00 00 00 
                shm_table.shm_pages[i].refcnt = 0;
80106eca:	c7 80 fc 54 11 80 00 	movl   $0x0,-0x7feeab04(%eax)
80106ed1:	00 00 00 
                break;
80106ed4:	eb ba                	jmp    80106e90 <shm_close+0x50>
